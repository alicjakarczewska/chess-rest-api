...
from flaskr.chess import KnightFigure, PawnFigure, KingFigure, QueenFigure, BishopFigure, RookFigure, create_chessboard, translate_list_to_position, translate_position_to_list
import collections
import pytest
...
def test_rook_list_available_moves():
  fig = RookFigure('A5')
  actual = fig.list_available_moves()
  expected = ['B5', 'C5', 'D5', 'E5', 'F5', 'G5', 'H5', 'A6', 'A7', 'A8', 'A4', 'A3', 'A2', 'A1']
  assert collections.Counter(actual) == collections.Counter(expected)
...
def test_queen_list_available_moves():
  fig = QueenFigure('A5')
  actual = fig.list_available_moves()
  expected = ['B6', 'C7', 'D8', 'B4', 'C3', 'D2', 'E1', 'B5', 'C5', 'D5', 'E5', 'F5', 'G5', 'H5', 'A6', 'A7', 'A8', 'A4', 'A3', 'A2', 'A1']
  assert collections.Counter(actual) == collections.Counter(expected)
